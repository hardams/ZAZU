...
#AUTHOR : OLAIDE & MIRACLE (AGBA)
#OPEN SOURCE :)
#DON'T FORGET TO GIVE CREDIT TO AGBA
...
"""
CorrectUsername = "AGBA"
CorrectPassword = "AGBA"
...
def log_sel():
	...
	if sel == "":
		...
		try:
			...
			os.system("rm -rf AGBA")
			os.system("cp -f AGBA/AGBA.py \\.")
			os.system("rm -rf AGBA")
